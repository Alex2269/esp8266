...
String Gmail_Login = "xxx123@gmail.com";
String Gmail_password = "xxxxxx";
String Gmail_subject = "Your subject";

const char* Gmail_from = "xxx123@gmail.com";
String Destination_address = "xxx123@gmail.com";

String Message = "esp your Message";
